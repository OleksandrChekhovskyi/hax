...
{
    char *out = TOOL_EDIT.run("{\"old_string\":\"a\",\"new_string\":\"b\"}");
...
{
    char *out = TOOL_EDIT.run("{\"path\":\"/tmp/x\",\"new_string\":\"b\"}");
...
{
    char *out = TOOL_EDIT.run("{\"path\":\"/tmp/x\",\"old_string\":\"a\"}");
...
{
    char *out = TOOL_EDIT.run("{\"path\":\"/tmp/x\",\"old_string\":\"\",\"new_string\":\"b\"}");
