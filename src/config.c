...
static const struct config_setting REGISTRY[] = {
    ...
    /* Vertex hax settings; Google's conventional environment variables are provider fallbacks. */
    {.key = "providers.vertex.project", .env_var = "HAX_VERTEX_PROJECT",
     .description = "Google Cloud project id for Vertex AI"},
    {.key = "providers.vertex.location", .env_var = "HAX_VERTEX_LOCATION",
     .description = "Vertex AI location (provider default: us-east5)"},
    {.key = "providers.vertex.access_token", .env_var = "HAX_VERTEX_ACCESS_TOKEN", .secret = 1,
     .description = "Explicit Google access token, bypassing ADC"},
